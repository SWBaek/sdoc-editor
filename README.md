...
VS Code Explorer에서 0바이트 또는 공백뿐인 `.sdoc` 파일을 만든 뒤 열어도 에디터 안에서 빈 문서로 초기화하거나 실험적 템플릿을 선택할 수 있습니다. 이 안내는 자동 팝업이 아니며, 손상된 JSON이나 지원하지 않는 미래 버전 문서는 빈 문서로 간주하지 않습니다.
