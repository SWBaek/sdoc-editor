...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_personal_template_candidates,
            commands::create_personal_template,
            commands::update_personal_template,
            commands::trash_personal_template,
            commands::reveal_personal_template_library,
