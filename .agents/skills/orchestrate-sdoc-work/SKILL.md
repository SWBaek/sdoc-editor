...
description: Coordinate bounded multi-agent work for Structured Doc Editor across the VS Code host, Tauri host, shared core, tests, and documentation. Use when a task explicitly requests subagents, delegation, or parallel review, or when a complex change has at least two independent exploration, implementation, verification, or review workstreams.
---
...
4. Prefer parallel exploration, architecture review, test analysis, and diff
   ...
   sequentially. Use a native architect for repository-grounded design help.
...
6. Run the applicable commands from `AGENTS.md`, inspect the final diff, and use
   repository evidence and native review to disposition findings before
   completion.
